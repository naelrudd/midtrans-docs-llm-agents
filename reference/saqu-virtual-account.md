---
updatedAt: 2026-08-18T19:21:29.000Z
---
...
# Saqu Virtual Account

Saqu Virtual Account is a bank transfer method facilitated by Bank Saqu. Payment can be made through ATM, mobile banking, internet banking, and Indonesian bank channels that supports paying virtual accounts.
...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Set what payment method to show in Snap's payment list. Value: `saqu_va`
      </td>
    </tr>
    ...
    <tr>
      <td>
        `saqu_va`  
        [Saqu Virtual Account](/reference/json-objects#saqu-virtual-account-object) (optional)
      </td>

      <td>
        Saqu Virtual Account payment options
      </td>
    </tr>
  </tbody>
</Table>
...
## API Operations for Saqu VA

Saqu VA supports two API operations: **Get Status**, and **Cancel**. These operations use the **transaction\_id** as the identifier to process the payment. The **transaction\_id** can be obtained from the HTTP notification (Webhook).
...
> 🚧 API Usage Notes
>
> * The **transaction\_id** is the key identifier for all API operations with Saqu VA. Ensure you retrieve and store this ID from the HTTP notification.
